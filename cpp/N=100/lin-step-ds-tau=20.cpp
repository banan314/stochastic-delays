...
const int tauA = 20, tauB = 0;
unsigned int d = 0;
const signed char N = 100;
default_random_engine generator;
uniform_real_distribution<double> distribution(0.0, 1.0);

size_t D_VALUE_NUMBER = 10;
int dValues[500u] = {52, 54, 56, 58, 60, 62, 64, 66, 68, 70};
...
int main()
{
    ...
    fstream io;
    io.open("./csv/N=100/lin-step-ds-tau-20.csv", ios_base::out | ios_base::app);
    if (!io.is_open())
    {
